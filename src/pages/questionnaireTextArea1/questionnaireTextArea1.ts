...
@Component({
  selector: 'page-questionnaireTextArea1',
  templateUrl: './questionnaireTextArea1.html'
})
export class QuestionnaireTextArea1Page {
    ...
    if((this.indexNum) < this.numTotalQuestions){
      ...
      switch (this.questions[this.indexNum].type) {
          case 'textArea':
            ...
            break;
          case 'image':
            this.navController.setRoot(QuestionnaireImagePage, { myQuestionnaire: this.myQuestionnaire, myCredentials: this.myCredentials, questions: this.questions, indexNum: this.indexNum, numAnswerCorrect: this.numAnswerCorrect, numAnswerNoCorrect: this.numAnswerNoCorrect, dataAnswers: this.dataAnswers });
            break;
          default:
            break;
        }
